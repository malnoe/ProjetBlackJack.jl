...
Pour installer le package Julia : ajouter le package depuis Pkg avec l'url https://github.com/malnoe/ProjetBlackJack.jl et pour connaitre les fonctions disponible dans ce package utilisez `help()`

Pour installer le package R : Executer le code R suivant 
```r
