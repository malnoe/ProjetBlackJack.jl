...
Ajoutez le package depuis Pkg avec l'url *https://github.com/malnoe/ProjetBlackJack.jl* et pour connaitre les fonctions disponible dans ce package utilisez `help()`.
